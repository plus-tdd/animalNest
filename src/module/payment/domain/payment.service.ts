...
export class PaymentService {
    constructor(
      ...
      public async refundPayment(refundInfo: RefundPaymentInfo): Promise<PaymentInfoForRefund> {
    ...
    // 결제 취소 SDK 연결
    public async paymentToSdkForRefund(requestInfo: PaymentInfoForRefund): Promise<string> {
        const externalSDK = new TestExternalPaymentSDK(); // 인스턴스 생성
